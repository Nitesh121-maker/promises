    ...
    <div>
        <div className="editor bg-gray-100 p-6 rounded-lg shadow-md">
            <div className="editor-controls mb-4 flex items-center">
                <div className="color-picker rounded-full overflow-hidden mr-2">
                    <input 
                        type="color" 
                        value={textColor} 
                ...
                <div className="background-color-picker rounded-full overflow-hidden mr-2">
                    <input 
                        type="color" 
                ...
                className="text-white bg-blue-500 rounded-md px-3 py-2 mr-2 hover:bg-blue-600"
                >
                B
                </button>
                <button 
                ...
                className="text-white bg-blue-500 rounded-md px-3 py-2 mr-1 hover:bg-blue-600"
                >
                U
                </button>
                <label className="text-white rounded-md px-2 py-2 mr-1 cursor-pointer">
            ...
            <div className="editor-content border border-gray-300 rounded-md p-4" style={{ backgroundColor }}>
                <Editor
